...
// "Test Club E2E <ts>", news "Опростена новина <ts>"). Matched by the exact e2e
// markers only — never the seeded "Насрочена новина (M0.4)" fixture. This is the
// immediate mitigation; full isolation via a dedicated test DB is a follow-up
// (docs/launch-runbook.md §2).
