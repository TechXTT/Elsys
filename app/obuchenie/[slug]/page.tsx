...
export default function ObuchenieDetail({ params }: { params: { slug: string } }) {
  const items = loadSectionItems('obuchenie');
  ...
  return (
    <div className="container-page py-10">
      ...
      <div className="mt-6 text-sm text-slate-500">Демо съдържание.</div>
    </div>
  );
}
